        ...
        <VForm @submit.prevent="submitForm">
          <VCardText>
            ...
            <VRow>
              ...
              <VCol cols="12" md="6">
                <!-- 👉 current password -->
                <VTextField class="mb-4" v-model="form.current_password"
                ...
                <!-- 👉 new password -->
                <VTextField class="mb-4" v-model="form.password" :type="isNewPasswordVisible ? 'text' : 'password'"
                ...
                <!-- 👉 confirm password -->
                <VTextField v-model="form.password_confirmation" :type="isConfirmPasswordVisible ? 'text' : 'password'"
