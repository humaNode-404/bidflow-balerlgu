...
<template>
  <VRow>
    ...
    <VCol sm="6" cols="12">
      <VCard>
        <div
          class="d-flex justify-space-between flex-md-nowrap flex-column flex-md-row flex-wrap"
        >
    ...
    <VCol md="6" lg="8" cols="12">
      <VCard>
        <VRow no-gutters>
          ...
          >
            <div
              class="membership-pricing d-flex flex-column align-center h-100 justify-center py-14"
            >
              <p class="mb-5">
